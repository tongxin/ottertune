...
PGSETTINGS = "settings.csv" if sys.argv[1] is None else sys.argv[1]

with open(PGSETTINGS, "r") as f:
...
PARAMS['max_parallel_workers']['tunable'] = 'yes'
PARAMS['max_parallel_workers_per_gather']['tunable'] = 'yes'  # Must be < max_worker_processes
PARAMS['max_pred_locks_per_relation']['tunable'] = 'no'
PARAMS['max_pred_locks_per_page']['tunable'] = 'no'
...
PARAMS['min_parallel_table_scan_size']['tunable'] = 'yes'
PARAMS['min_parallel_index_scan_size']['tunable'] = 'yes'
...
PARAMS['wal_consistency_checking']['tunable'] = 'no'
...
with open("postgres-11beta3_knobs.json", "w") as f:
